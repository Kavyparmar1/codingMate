    ...
    <div className='h-screen w-full flex items-center justify-end p-10  fixed' >
        ...
        <br />
           <div className='flex items-center justify-center gap-4'>
            <spam className='text-2xl font-thin bg-black text-pink-300 px-4 py-2 rounded-xl'>AI code reviewer</spam>
            <spam className='text-2xl font-thin bg-pink-300 text-black px-4 py-2 rounded-xl  '>AI productivity mentor</spam>
           </div>
        </div>
